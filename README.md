...
# _**Classifying The Types Of Flowers Using Convolutional Neural Networks**_
...
8.	If you want to build your own model for detection, you can go through “flower_classification_model_build.ipynb”
9.      Type flower_classification.ipynb to get the results.
